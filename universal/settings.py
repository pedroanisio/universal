...
SECRET_KEY = 'django-insecure-ebz%47-h8sorudh(*+fqal33a(b^=%#l_-5nw7y4^ovp$=so(q'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
ALLOWED_HOSTS = ['0.0.0.0','10.10.10.53','localhost']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'universal'),
